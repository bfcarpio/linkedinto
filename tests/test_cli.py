...
class TestCli:
    ...
    def test_convert_outputs_both(self, cli_sample_zip: Path) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            result = runner.invoke(
                app, ["convert", str(cli_sample_zip), "--output-dir", tmpdir]
            )
    ...
    def test_convert_jsonresume_only(self, cli_sample_zip: Path) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            result = runner.invoke(
                app,
                [
    ...
    def test_convert_rendercv_only(self, cli_sample_zip: Path) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            result = runner.invoke(
                app,
                [
